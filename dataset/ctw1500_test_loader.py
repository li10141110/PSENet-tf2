...
class CTW1500TestLoader():
    ...
    def __getitem__(self, index):
        ...
        scaled_img = (scaled_img / 255.).astype('float32')
...
def ctw_test_loader(dataset, batch_size):
    ...
    for i in range(num_iter):
        ...
        for j in range(batch_size):
            ...
            scaled_img.append(sample[1])
            
        imgs = tf.stack(imgs, 0)
        scaled_imgs = tf.stack(scaled_img, 0)
        yield imgs, scaled_imgs, data_length